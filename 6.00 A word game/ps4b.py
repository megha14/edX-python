...
def compPlayHand(hand, wordList, n):
    ...
    while(calculateHandlen(hand) > 0):
        ...
        if user_input == None:
            ...
            print '"'+str(user_input)+'"'+" earned "+str(getWordScore(user_input,n))+" points. Total: "+str(total_score)+" points"
            print ""
            # Update the hand 
...
def playGame(wordList):
    ...
    while(True):
        ...
        if user_input == 'e':
            ...
            while True:
                user_input_1 = raw_input("Enter u to have yourself play, c to have the computer play: ")
                if user_input_1=='u':
